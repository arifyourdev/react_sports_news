...
const PrivacyPolicy = () => {
  return (
    <>
      <Helmet>
        <title>Cricfeel | Privacy Policy</title>
      </Helmet>
      <Header />
            ...
            <section className="CricketmasterSection">
                <div className="container">
                    <div className="CustomContainer">
                        <div className="row">
                            <div className="contents-holders privacy-content">
                                <h3>Cricfeel Privacy Policy</h3>
                                <p>
                                Welcome to Cricfeel. By visiting our website and App (Android & iOS) you are agreeing to be bound by the following terms and conditions. Please read these terms and conditions before using, or submitting content in any form or medium for publication on, Cricfeel.com and App. We may change these terms and conditions at any time. Your continued use implies that you accept any new or modified terms and conditions that we come up with. Please re-visit the 'Terms of Use' link at our site from time to time to stay updated with any changes that we may introduce.
                                </p>
                                <br />
                                <p>
                                Cricfeel is strongly committed to your right to privacy and to keeping your personal information secure. To earn your trust and confidence in our commitment, we are fully disclosing our privacy practices. We encourage you to read our privacy statement to understand what types of personally identifiable information we collect and how we use this information. Cricfeel has the right to amend its privacy policy to suit the needs of the website and we will inform you about the updated regulations at the earliest possible time.
                                </p>
                                <br />
